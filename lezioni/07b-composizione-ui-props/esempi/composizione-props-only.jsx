...
// Gruppo di bottoni
function ButtonGroup({ children, spacing = '10px' }) {
  return (
    <div style={{ 
      display: 'flex',
      gap: spacing,
...
function UserList({ users, showDetails = false }) {
  return (
    <div>
...
function FormField({ label, type = 'text', value, placeholder, required = false }) {
  return (
...
function DataDisplay({ data, renderItem }) {
  return (
    <div style={{ 
      display: 'grid',
