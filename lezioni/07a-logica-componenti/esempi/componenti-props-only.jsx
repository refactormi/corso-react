...
function Button({ children, onClick, variant = 'primary', size = 'medium', disabled = false }) {
...
function Card({ title, children, footer, variant = 'default' }) {
  const variantStyles = {
...
function UserList({ users, title = "Lista Utenti" }) {
...
function Dashboard({ users, stats, onAction }) {
  return (
