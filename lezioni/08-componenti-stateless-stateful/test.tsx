...
describe('Lezione 8: useState e Gestione Stato', () => {
  ...
  describe('SimpleCounter', () => {
    test('renderizza il contatore con valore iniziale 0', () => {
      ...
      expect(screen.getByText(/Stato attuale: 0/)).toBeInTheDocument()
    })
    ...
    test('incrementa il contatore quando si clicca +1', () => {
      ...
      expect(screen.getByText(/Stato attuale: 1/)).toBeInTheDocument()
      
      fireEvent.click(incrementButton)
      expect(screen.getByText(/Stato attuale: 2/)).toBeInTheDocument()
    })
  ...
  describe('TodoList', () => {
    ...
    test('aggiunge un nuovo todo', () => {
      render(<TodoList />)
      const input = screen.getByPlaceholderText('Scrivi un nuovo todo...') as HTMLInputElement
  ...
  describe('ContactForm', () => {
    ...
    test('valida la lunghezza del messaggio', async () => {
      ...
      const messageInput = screen.getByPlaceholderText('Scrivi il tuo messaggio...') as HTMLTextAreaElement
      const submitButton = screen.getByText('Invia Messaggio')
