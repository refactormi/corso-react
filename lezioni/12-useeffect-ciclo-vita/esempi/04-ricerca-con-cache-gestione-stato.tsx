...
function SearchResult({ result, onSelect }) {
  ...
  return (
    ...
    >
      <h4 style={{  margin: '0 0 8px 0', color: '#333' } as React.CSSProperties}>
        {result.title}
      </h4>
      <div style={{  display: 'flex', gap: '15px', fontSize: '14px', color: '#666' } as React.CSSProperties}>
...
function SearchWithCache() {
  ...
  return (
    <div style={{  
      ...
      {/* Barra di ricerca */}
      <div style={{  position: 'relative', marginBottom: '20px' } as React.CSSProperties}>
        <input
          type="text"
          value={query}
        ...
        <div style={{  marginBottom: '20px' } as React.CSSProperties}>
          ...
          {showHistory && (
            <div style={{  
              ...
              <div style={{  display: 'flex', flexWrap: 'wrap', gap: '5px' } as React.CSSProperties}>
      ...
      {process.env.NODE_ENV === 'development' && (
        <details style={{  marginTop: '20px' } as React.CSSProperties}>
          <summary style={{  cursor: 'pointer', fontWeight: 'bold' } as React.CSSProperties}>
            Debug Info
          </summary>
          <pre style={{  
            backgroundColor: '#f8f9fa', 
