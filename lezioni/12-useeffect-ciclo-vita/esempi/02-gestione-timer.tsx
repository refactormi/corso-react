...
function LapList({ laps }) {
  if (laps.length === 0) {
    return (
      <div style={{ 
        ...
        <div style={{  fontSize: '32px', marginBottom: '10px' } as React.CSSProperties}>⏱️</div>
        <p>Nessun giro registrato</p>
        <p style={{  fontSize: '12px' } as React.CSSProperties}>Premi "Giro" per registrare i tempi</p>
      </div>
    );
  }
  ...
  return (
    <div style={{ 
      ...
      <h4 style={{  margin: '0 0 15px 0', color: '#333' } as React.CSSProperties}>📊 Giri Registrati</h4>
      ...
      {laps.map((lap, index) => {
        ...
        return (
          ...
          >
            <span style={{  fontWeight: 'bold' } as React.CSSProperties}>{laps.length - index}</span>
            <span style={{  
            ...
            <span style={{  color: '#666' } as React.CSSProperties}>
  ...
  return (
    <div style={{ 
      ...
      <div style={{ 
        ...
        <h2 style={{  margin: '0 0 20px 0', color: '#333' } as React.CSSProperties}>⏱️ Cronometro</h2>
  ...
  return (
    <div style={{ 
      ...
      <div style={{ 
        ...
        <h2 style={{  margin: '0 0 20px 0', color: '#333' } as React.CSSProperties}>⏰ Timer Countdown</h2>
        
        {isSetting ? (
          <div>
            <div style={{  marginBottom: '20px' } as React.CSSProperties}>
              <label style={{  display: 'block', marginBottom: '10px', color: '#666' } as React.CSSProperties}>
          ...
          <div>
            ...
            <div style={{  display: 'flex', justifyContent: 'center', gap: '15px' } as React.CSSProperties}>
              <button
    ...
    <div style={{ 
      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          <h3 style={{  margin: '0 0 15px 0', color: '#333' } as React.CSSProperties}>ℹ️ Informazioni</h3>
          <ul style={{  margin: 0, paddingLeft: '20px', color: '#666' } as React.CSSProperties}>
