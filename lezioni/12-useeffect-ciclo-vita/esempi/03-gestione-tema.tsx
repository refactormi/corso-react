...
function ThemeSelector() {
  ...
  return (
    <div style={{ 
      ...
      <h3 style={{  margin: '0 0 15px 0', color: 'var(--text-color)' } as React.CSSProperties}>
        🎨 Tema
      </h3>
      
      <div style={{  display: 'flex', gap: '10px', marginBottom: '15px' } as React.CSSProperties}>
        <button
      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            <ul style={{  margin: 0, paddingLeft: '20px', color: 'var(--text-secondary)' } as React.CSSProperties}>
