  ...
  return (
    <div style={{  
      ...
      <div style={{  
        ...
        <h2 style={{  margin: 0, color: '#333' } as React.CSSProperties}>👥 Utenti</h2>
        <button 
          onClick={onRefresh} 
          disabled={loading}
          style={{ 
          ...
          {users.map(user => (
            ...
            >
              <div style={{  display: 'flex', alignItems: 'center', marginBottom: '8px' } as React.CSSProperties}>
                ...
                <div>
                  <strong style={{  display: 'block', color: '#333' } as React.CSSProperties}>{user.name}</strong>
                  <small style={{  color: '#666' } as React.CSSProperties}>{user.role}</small>
                </div>
              </div>
              <div style={{  fontSize: '14px', color: '#666' } as React.CSSProperties}>
                📧 {user.email}
              </div>
              <div style={{  fontSize: '12px', color: '#999', marginTop: '4px' } as React.CSSProperties}>
  ...
  if (!selectedUser) {
    return (
      <div style={{  
        ...
        <h2 style={{  color: '#666', marginBottom: '10px' } as React.CSSProperties}>Seleziona un utente</h2>
        <p style={{  color: '#999', maxWidth: '400px' } as React.CSSProperties}>
  ...
  return (
    <div style={{  
      ...
      <div style={{  
        ...
        <div>
          <h2 style={{  margin: 0, color: '#333' } as React.CSSProperties}>Dettagli Utente</h2>
          <p style={{  margin: '5px 0 0 0', color: '#666' } as React.CSSProperties}>
      ...
      {isEditing ? (
        <div style={{  maxWidth: '500px' } as React.CSSProperties}>
          ...
          <div style={{  display: 'flex', gap: '15px' } as React.CSSProperties}>
            <button 
              onClick={handleSave}
              disabled={saving}
              style={{ 
        ...
        <div style={{  maxWidth: '600px' } as React.CSSProperties}>
          <div style={{  
            ...
            <div>
              <h3 style={{  margin: '0 0 5px 0', fontSize: '24px' } as React.CSSProperties}>{selectedUser.name}</h3>
              <p style={{  margin: '0 0 5px 0', color: '#666' } as React.CSSProperties}>{selectedUser.email}</p>
              <span style={{ 
                padding: '4px 12px',
          ...
          <div style={{  display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' } as React.CSSProperties}>
            <div style={{  
              ...
              <h4 style={{  margin: '0 0 15px 0', color: '#333' } as React.CSSProperties}>📊 Informazioni</h4>
            ...
            <div style={{  
              ...
              <h4 style={{  margin: '0 0 15px 0', color: '#333' } as React.CSSProperties}>📝 Bio</h4>
              {selectedUser.bio ? (
                <p style={{  margin: 0, lineHeight: '1.5' } as React.CSSProperties}>{selectedUser.bio}</p>
              ) : (
                <p style={{  margin: 0, color: '#666', fontStyle: 'italic' } as React.CSSProperties}>
