...
function RegistrationForm(): JSX.Element {
  ...
  const { values, errors, touched, handleChange, handleBlur, validateAll, reset } = useForm<RegistrationFormValues>(
    {
      firstName: '',
      lastName: '',
      email: '',
...
function EventHandlingDemo(): JSX.Element {
...
export default function Demo11(): JSX.Element {
  return (
