...
function ScrollToElement(): JSX.Element {
...
function DOMMeasurements(): JSX.Element {
  const divRef = useRef<HTMLDivElement>(null);
  const [measurements, setMeasurements] = useState<Measurements>({});
  const [content, setContent] = useState<string>('Contenuto iniziale');
...
function CounterWithoutRerender(): JSX.Element {
...
function PerformanceMonitor(): JSX.Element {
  const renderCountRef = useRef<number>(0);
...
export default function Demo13(): JSX.Element {
  return (
